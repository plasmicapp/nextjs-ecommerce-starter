...
# Plasmic Ecommerce Starter Kit

The all-in-one starter kit for high-performance e-commerce sites, featuring integration with Plasmic's visual CMS.
With a few clicks, Next.js developers can clone, deploy and fully customize their own store.
